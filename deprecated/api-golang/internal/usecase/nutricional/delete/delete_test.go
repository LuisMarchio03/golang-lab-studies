...
func (suite *DeleteNutricionalUsecaseTestSuite) TestDeleteNutricional() {
	...
	deleleNutricionalUsecase := NewDeleleNutricionalUsecase(nutricionalRepository)
	err = deleleNutricionalUsecase.Execute("123")
	suite.NoError(err)
}
